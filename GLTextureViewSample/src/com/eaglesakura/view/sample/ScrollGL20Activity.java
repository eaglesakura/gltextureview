...
public class ScrollGL20Activity extends Activity implements Renderer {
    static final String TAG = ScrollGL20Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(getLayoutInflater().inflate(R.layout.layout_scrollgltextureview, null));
        glTextureView = (GLTextureView) findViewById(R.id.v1);
