...
public class UIThreadSimpleGL11Activity extends Activity implements Renderer {
    static final String TAG = UIThreadSimpleGL11Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup GLTextureView
        {
            //            glTextureView.setVersion(GLESVersion.OpenGLES11); // Default OpenGLES11
